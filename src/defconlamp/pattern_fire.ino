...
// feel of your fire: FIRE_COOLING (used in step 1 above), and FIRE_SPARKING (used
// in step 3 above).
//
// FIRE_COOLING: How much does the air cool as it rises?
// Less FIRE_COOLING = taller flames.  More FIRE_COOLING = shorter flames.
...
bool gFireReverseDirection = false;
